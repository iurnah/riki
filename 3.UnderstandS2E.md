...
- [BaseInstructioins.cpp](#BaseInstructioins.cpp) _s2e basic functionalities, `makeSybolic()` etc._
- [BaseInstructioins.h](#BaseInstructioins.h) 
...
- [OS Monitor.h](#OS Monitor.h) _define signals such as `onModuleLoad`, `onProcessUnload`, and member functions such as `getImports()`, `getCurrentStack()`._
