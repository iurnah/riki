...
- [BaseInstructions.cpp](#BaseInstructions.cpp) _s2e basic functionalities, `makeSymbolic()` etc._ 
...
It is basically reimplement the signals in the `ModuleExeuctionDetection` plugin. The reason it exist is because it trace and write the module load and unload information to the ExecutionTracer.dat file and may help in future file parsing.
